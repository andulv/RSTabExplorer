...
namespace alphatab{
	public  class Settings : global::haxe.lang.HxObject {
		...
		public static   void __hx_ctor_alphatab_Settings(global::alphatab.Settings __temp_me51){
			unchecked {
				{
				}
		...
		public static   global::alphatab.Settings defaults(){
			unchecked {
				...
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("marker") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("tempo") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("text") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("chords") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("trill") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("beat-vibrato") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("note-vibrato") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("alternate-endings") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("score") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("crescendo") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("dynamics") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("trill") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("beat-vibrato") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("note-vibrato") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("tap") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("fade-in") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("let-ring") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("palm-mute") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("tab") )));
				settings.staves.push(new global::alphatab.StaveSettings(((string) ("pick-stroke") )));
				return settings;
			}
		}
...
namespace alphatab{
	public  class LayoutSettings : global::haxe.lang.HxObject {
		...
		public static   void __hx_ctor_alphatab_LayoutSettings(global::alphatab.LayoutSettings __temp_me52){
			unchecked {
				__temp_me52.additionalSettings = new global::haxe.ds.StringMap<object>();
			}
		}
		...
		public virtual   T @get<T>(string key, T def){
			unchecked {
				if (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(this.additionalSettings, "exists", 1071652316, new global::haxe.root.Array<object>(new object[]{key})))) {
...
namespace alphatab{
	public  class StaveSettings : global::haxe.lang.HxObject {
		...
		public static   void __hx_ctor_alphatab_StaveSettings(global::alphatab.StaveSettings __temp_me53, string id){
			unchecked {
				__temp_me53.id = id;
				__temp_me53.additionalSettings = new global::haxe.ds.StringMap<object>();
			}
		}
