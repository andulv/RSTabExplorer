...
namespace alphatab.rendering.glyphs{
	public  class GlyphGroup : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_GlyphGroup(global::alphatab.rendering.glyphs.GlyphGroup __temp_me130, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::haxe.root.Array<object> glyphs){
			unchecked {
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me130, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ));
				int __temp_y129 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x128 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				if (( glyphs != default(global::haxe.root.Array<object>) )) {
					__temp_me130._glyphs = glyphs;
				}
				 else {
					__temp_me130._glyphs = new global::haxe.root.Array<object>();
				}
