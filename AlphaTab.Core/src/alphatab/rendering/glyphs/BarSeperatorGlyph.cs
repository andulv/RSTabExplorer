...
namespace alphatab.rendering.glyphs{
	public  class BarSeperatorGlyph : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_BarSeperatorGlyph(global::alphatab.rendering.glyphs.BarSeperatorGlyph __temp_me141, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::haxe.lang.Null<bool> isLast){
			unchecked {
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me141, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ));
				bool __temp_isLast140 = ( ( ! (isLast.hasValue) ) ? (global::haxe.lang.Runtime.toBool(false)) : (isLast.@value) );
				int __temp_y139 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x138 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me141._isLast = __temp_isLast140;
			}
		}
		...
		public override   object __hx_setField(string field, int hash, object @value, bool handleProperties){
			unchecked {
				switch (hash){
					case 1401610495:
					{
						this._isLast = global::haxe.lang.Runtime.toBool(@value);
						return @value;
					}
