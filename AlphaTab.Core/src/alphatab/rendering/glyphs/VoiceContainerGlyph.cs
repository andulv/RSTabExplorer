...
namespace alphatab.rendering.glyphs{
	public  class VoiceContainerGlyph : global::alphatab.rendering.glyphs.GlyphGroup, global::alphatab.rendering.glyphs.ISupportsFinalize {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_VoiceContainerGlyph(global::alphatab.rendering.glyphs.VoiceContainerGlyph __temp_me244, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, int voiceIndex){
			unchecked {
				global::alphatab.rendering.glyphs.GlyphGroup.__hx_ctor_alphatab_rendering_glyphs_GlyphGroup(__temp_me244, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ), default(global::haxe.root.Array<object>));
				int __temp_y243 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x242 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me244.beatGlyphs = new global::haxe.root.Array<object>();
				__temp_me244.voiceIndex = voiceIndex;
			}
		}
