...
namespace alphatab.rendering.glyphs.effects{
	public  class CrescendoGlyph : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_effects_CrescendoGlyph(global::alphatab.rendering.glyphs.effects.CrescendoGlyph __temp_me248, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::alphatab.rendering.glyphs.CrescendoType crescendo){
			unchecked {
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me248, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ));
				int __temp_y247 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x246 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me248._crescendo = crescendo;
			}
		}
