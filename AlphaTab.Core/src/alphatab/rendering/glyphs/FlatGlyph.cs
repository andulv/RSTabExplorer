...
namespace alphatab.rendering.glyphs
{
	public  class FlatGlyph : global::alphatab.rendering.glyphs.SvgGlyph 
	{
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_FlatGlyph(global::alphatab.rendering.glyphs.FlatGlyph __temp_me157, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::haxe.lang.Null<bool> isGrace)
		{
			unchecked 
			{
				bool __temp_isGrace156 = ( (global::haxe.lang.Runtime.eq((isGrace).toDynamic(), (default(global::haxe.lang.Null<bool>)).toDynamic())) ? (((bool) (false) )) : (isGrace.@value) );
				int __temp_y155 = ( (global::haxe.lang.Runtime.eq((y).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (y.@value) );
				int __temp_x154 = ( (global::haxe.lang.Runtime.eq((x).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (x.@value) );
				global::alphatab.rendering.glyphs.SvgGlyph.__hx_ctor_alphatab_rendering_glyphs_SvgGlyph(__temp_me157, new global::haxe.lang.Null<int>(__temp_x154, true), new global::haxe.lang.Null<int>(__temp_y155, true), global::alphatab.rendering.glyphs.MusicFont.AccidentalFlat, ( (__temp_isGrace156) ? (0.7) : (((double) (1) )) ), ( (__temp_isGrace156) ? (0.7) : (((double) (1) )) ));
				__temp_me157._isGrace = __temp_isGrace156;
			}
		}
