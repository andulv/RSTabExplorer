...
namespace alphatab.io{
	public  class BytesArray : global::haxe.lang.HxObject {
		...
		public static   void __hx_ctor_alphatab_io_BytesArray(global::alphatab.io.BytesArray __temp_me84, global::haxe.lang.Null<int> initialSize){
			unchecked {
				int __temp_initialSize83 = ( ( ! (initialSize.hasValue) ) ? (((int) (4) )) : (initialSize.@value) );
				__temp_me84._data = global::haxe.io.Bytes.alloc(__temp_initialSize83);
				__temp_me84.length = 0;
			}
		}
		...
		public virtual   global::haxe.io.Bytes getBytes(global::haxe.lang.Null<int> offset){
			unchecked {
				int __temp_offset82 = ( ( ! (offset.hasValue) ) ? (((int) (0) )) : (offset.@value) );
				global::haxe.io.Bytes copy = global::haxe.io.Bytes.alloc(this.length);
				copy.blit(0, this._data, __temp_offset82, ( this.length - __temp_offset82 ));
				return copy;
			}
		}
		...
		public override   object __hx_getField(string field, int hash, bool throwErrors, bool isCheck, bool handleProperties){
			unchecked {
				switch (hash){
					case 2028270691:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("updateCapacity") ), ((int) (2028270691) ))) );
					}
					
					
					case 1947978492:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("setCapacity") ), ((int) (1947978492) ))) );
					}
					
					
					case 2027205955:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("get_capacity") ), ((int) (2027205955) ))) );
					}
					...
					case 1290487350:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("getBuffer") ), ((int) (1290487350) ))) );
					}
					
					
					case 922037898:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("addBytes") ), ((int) (922037898) ))) );
					}
		...
		public override   double __hx_getField_f(string field, int hash, bool throwErrors, bool handleProperties){
			unchecked {
				switch (hash){
					...
					case 1136329018:
					{
						return ((double) (this.get_capacity()) );
					}
