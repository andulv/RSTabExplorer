...
namespace alphatab.rendering
{
	public  class AlternateEndingsBarRendererFactory : global::alphatab.rendering.BarRendererFactory 
	{
		...
		public static   void __hx_ctor_alphatab_rendering_AlternateEndingsBarRendererFactory(global::alphatab.rendering.AlternateEndingsBarRendererFactory __temp_me37)
		{
			unchecked 
			{
				global::alphatab.rendering.BarRendererFactory.__hx_ctor_alphatab_rendering_BarRendererFactory(__temp_me37);
				__temp_me37.isInAccolade = false;
			}
		}
