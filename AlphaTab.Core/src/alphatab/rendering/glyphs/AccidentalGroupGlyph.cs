...
namespace alphatab.rendering.glyphs{
	public  class AccidentalGroupGlyph : global::alphatab.rendering.glyphs.GlyphGroup {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_AccidentalGroupGlyph(global::alphatab.rendering.glyphs.AccidentalGroupGlyph __temp_me133, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y){
			unchecked {
				global::alphatab.rendering.glyphs.GlyphGroup.__hx_ctor_alphatab_rendering_glyphs_GlyphGroup(__temp_me133, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ), new global::haxe.root.Array<object>());
				int __temp_y132 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x131 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
			}
		}
