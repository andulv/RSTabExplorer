...
namespace alphatab.rendering.utils{
	public  class SvgPathParser : global::haxe.lang.HxObject {
		...
		public static   void __hx_ctor_alphatab_rendering_utils_SvgPathParser(global::alphatab.rendering.utils.SvgPathParser __temp_me293, string svg){
			unchecked {
				__temp_me293.svg = svg;
			}
		}
		...
		public static   bool isNumber(string s, global::haxe.lang.Null<bool> allowSign){
			unchecked {
				bool __temp_allowSign292 = ( ( ! (allowSign.hasValue) ) ? (global::haxe.lang.Runtime.toBool(true)) : (allowSign.@value) );
				if (( s.Length == 0 )) {
					return false;
				}
				...
				return ( ( __temp_allowSign292 && ( c == 45 ) ) || ( ( c >= 48 ) && ( c <= 57 ) ) );
			}
		}
		...
		public virtual   int getNumber(){
			unchecked {
				return global::haxe.root.Std.parseInt(this.getString()).@value;
			}
		}
		...
		public virtual   void nextToken(){
			unchecked {
				...
				if ((  ! (this.eof())  ||  ! (skipChar)  )) {
					token.b.Append(((object) (global::haxe.root.Std.@string(c)) ));
					if (global::alphatab.rendering.utils.SvgPathParser.isNumber(c, default(global::haxe.lang.Null<bool>))) {
						...
						while ((  ! (this.eof())  && (( global::alphatab.rendering.utils.SvgPathParser.isNumber(c, new global::haxe.lang.Null<bool>(false, true)) || string.Equals(c, ".") )) )){
							{
								string x = this.nextChar();
								token.b.Append(((object) (global::haxe.root.Std.@string(x)) ));
							}
		...
		public override   object __hx_getField(string field, int hash, bool throwErrors, bool isCheck, bool handleProperties){
			unchecked {
				switch (hash){
					case 997235974:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("nextToken") ), ((int) (997235974) ))) );
					}
					
					
					case 411948561:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("peekChar") ), ((int) (411948561) ))) );
					}
					...
					case 1349863027:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("currentTokenIsNumber") ), ((int) (1349863027) ))) );
					}
					
					
					case 500240383:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("getNumber") ), ((int) (500240383) ))) );
					}
					...
					case 5047484:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("eof") ), ((int) (5047484) ))) );
					}
					
					
					case 1724402127:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("reset") ), ((int) (1724402127) ))) );
					}
