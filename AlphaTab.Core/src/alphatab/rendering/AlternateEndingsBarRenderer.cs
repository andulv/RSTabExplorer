...
namespace alphatab.rendering
{
	public  class AlternateEndingsBarRenderer : global::alphatab.rendering.BarRendererBase 
	{
		...
		public static   void __hx_ctor_alphatab_rendering_AlternateEndingsBarRenderer(global::alphatab.rendering.AlternateEndingsBarRenderer __temp_me91, global::alphatab.model.Bar bar)
		{
			unchecked 
			{
				global::alphatab.rendering.BarRendererBase.__hx_ctor_alphatab_rendering_BarRendererBase(__temp_me91, bar);
				int alternateEndings = ((global::alphatab.model.MasterBar) (bar.track.score.masterBars[bar.index]) ).alternateEndings;
				__temp_me91._endings = new global::haxe.root.Array<int>();
				{
					int _g = 0;
					while (( _g < 8 ))
					{
