...
namespace alphatab.rendering.glyphs{
	public  class SharpGlyph : global::alphatab.rendering.glyphs.SvgGlyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_SharpGlyph(global::alphatab.rendering.glyphs.SharpGlyph __temp_me221, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::haxe.lang.Null<bool> isGrace){
			unchecked {
				global::alphatab.rendering.glyphs.SvgGlyph.__hx_ctor_alphatab_rendering_glyphs_SvgGlyph(__temp_me221, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ), global::alphatab.rendering.glyphs.MusicFont.AccidentalSharp, ( (( ( ! (isGrace.hasValue) ) ? (new global::haxe.lang.Null<bool>(false, true)) : (isGrace) )) ? (0.7) : (((double) (1) )) ), ( (( ( ! (isGrace.hasValue) ) ? (new global::haxe.lang.Null<bool>(false, true)) : (isGrace) )) ? (0.7) : (((double) (1) )) ));
				bool __temp_isGrace220 = ( ( ! (isGrace.hasValue) ) ? (global::haxe.lang.Runtime.toBool(false)) : (isGrace.@value) );
				int __temp_y219 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x218 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me221._isGrace = __temp_isGrace220;
			}
		}
