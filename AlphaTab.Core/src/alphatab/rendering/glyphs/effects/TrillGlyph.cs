...
namespace alphatab.rendering.glyphs.effects{
	public  class TrillGlyph : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_effects_TrillGlyph(global::alphatab.rendering.glyphs.effects.TrillGlyph __temp_me273, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::haxe.lang.Null<double> scale){
			unchecked {
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me273, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ));
				double __temp_scale272 = ( ( ! (scale.hasValue) ) ? (((double) (0.9) )) : (scale.@value) );
				int __temp_y271 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x270 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me273._scale = __temp_scale272;
			}
		}
			...
			unchecked {
				...
				int loopX = ((int) (startX) );
				{
					...
					while (( _g < loops )){
						...
						int __temp_stmt637 = default(int);
						{
							double x1 = ( res.markerFont.getSize() / 2 );
							__temp_stmt637 = ((int) (x1) );
						}
						
						glyph.paint(( cx + this.x ), ( ( cy + this.y ) + __temp_stmt637 ), canvas);
						{
