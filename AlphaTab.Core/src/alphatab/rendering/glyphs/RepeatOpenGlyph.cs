...
namespace alphatab.rendering.glyphs
{
	public  class RepeatOpenGlyph : global::alphatab.rendering.Glyph 
	{
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_RepeatOpenGlyph(global::alphatab.rendering.glyphs.RepeatOpenGlyph __temp_me183, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, double circleSize, int dotOffset)
		{
			unchecked 
			{
				int __temp_y182 = ( (global::haxe.lang.Runtime.eq((y).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (y.@value) );
				int __temp_x181 = ( (global::haxe.lang.Runtime.eq((x).toDynamic(), (default(global::haxe.lang.Null<int>)).toDynamic())) ? (((int) (0) )) : (x.@value) );
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me183, new global::haxe.lang.Null<int>(__temp_x181, true), new global::haxe.lang.Null<int>(__temp_y182, true));
				__temp_me183._dotOffset = dotOffset;
				__temp_me183._circleSize = circleSize;
			}
		}
