...
namespace alphatab.rendering.glyphs{
	public  class TremoloPickingGlyph : global::alphatab.rendering.glyphs.SvgGlyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_TremoloPickingGlyph(global::alphatab.rendering.glyphs.TremoloPickingGlyph __temp_me241, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::alphatab.model.Duration duration){
			unchecked {
				global::alphatab.rendering.glyphs.SvgGlyph.__hx_ctor_alphatab_rendering_glyphs_SvgGlyph(__temp_me241, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ), __temp_me241.getSvg(duration), ((double) (1) ), ((double) (1) ));
				int __temp_y240 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x239 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
			}
		}
