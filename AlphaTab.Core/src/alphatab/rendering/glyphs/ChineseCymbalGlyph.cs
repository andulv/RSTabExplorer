...
namespace alphatab.rendering.glyphs{
	public  class ChineseCymbalGlyph : global::alphatab.rendering.glyphs.SvgGlyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_ChineseCymbalGlyph(global::alphatab.rendering.glyphs.ChineseCymbalGlyph __temp_me150, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, bool isGrace){
			unchecked {
				global::alphatab.rendering.glyphs.SvgGlyph.__hx_ctor_alphatab_rendering_glyphs_SvgGlyph(__temp_me150, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ), global::alphatab.rendering.glyphs.MusicFont.NoteChineseCymbal, ( (isGrace) ? (0.7) : (((double) (1) )) ), ( (isGrace) ? (0.7) : (((double) (1) )) ));
				int __temp_y149 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x148 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me150._isGrace = isGrace;
			}
		}
		...
		public static  new object __hx_create(global::haxe.root.Array arr){
			unchecked {
				return new global::alphatab.rendering.glyphs.ChineseCymbalGlyph(global::haxe.lang.Null<object>.ofDynamic<int>(arr[0]), global::haxe.lang.Null<object>.ofDynamic<int>(arr[1]), global::haxe.lang.Runtime.toBool(arr[2]));
			}
		}
