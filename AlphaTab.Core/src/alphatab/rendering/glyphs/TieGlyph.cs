...
namespace alphatab.rendering.glyphs{
	public  class TieGlyph : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_TieGlyph(global::alphatab.rendering.glyphs.TieGlyph __temp_me216, global::alphatab.model.Note startNote, global::alphatab.model.Note endNote, global::alphatab.rendering.Glyph parent){
			unchecked {
				...
				__temp_me216._startNote = startNote;
				__temp_me216._endNote = endNote;
				__temp_me216._parent = parent;
			}
		}
		...
		public static   void paintTie(global::alphatab.platform.ICanvas canvas, double scale, double x1, double y1, double x2, double y2, global::haxe.lang.Null<bool> down){
			unchecked {
				bool __temp_down215 = ( ( ! (down.hasValue) ) ? (global::haxe.lang.Runtime.toBool(false)) : (down.@value) );
				if (( x2 > x1 )) {
					double t = x1;
					x1 = x2;
					x2 = t;
