...
namespace alphatab.rendering.glyphs{
	public  class HiHatGlyph : global::alphatab.rendering.glyphs.SvgGlyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_HiHatGlyph(global::alphatab.rendering.glyphs.HiHatGlyph __temp_me175, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, bool isGrace){
			unchecked {
				global::alphatab.rendering.glyphs.SvgGlyph.__hx_ctor_alphatab_rendering_glyphs_SvgGlyph(__temp_me175, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ), global::alphatab.rendering.glyphs.MusicFont.NoteHiHat, ( (isGrace) ? (0.7) : (((double) (1) )) ), ( (isGrace) ? (0.7) : (((double) (1) )) ));
				int __temp_y174 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x173 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me175._isGrace = isGrace;
			}
		}
		...
		public static  new object __hx_create(global::haxe.root.Array arr){
			unchecked {
				return new global::alphatab.rendering.glyphs.HiHatGlyph(global::haxe.lang.Null<object>.ofDynamic<int>(arr[0]), global::haxe.lang.Null<object>.ofDynamic<int>(arr[1]), global::haxe.lang.Runtime.toBool(arr[2]));
			}
		}
