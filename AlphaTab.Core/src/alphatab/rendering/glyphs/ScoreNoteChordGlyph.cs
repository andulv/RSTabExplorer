...
namespace alphatab.rendering.glyphs{
	public  class ScoreNoteChordGlyph : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_ScoreNoteChordGlyph(global::alphatab.rendering.glyphs.ScoreNoteChordGlyph __temp_me213, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y){
			unchecked {
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me213, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ));
				int __temp_y212 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x211 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me213._infos = new global::haxe.root.Array<object>();
				__temp_me213.beatEffects = new global::haxe.ds.StringMap<object>();
				__temp_me213._noteLookup = new global::haxe.ds.IntMap<object>();
			}
		}
		...
		public virtual   int getNoteX(global::alphatab.model.Note note, global::haxe.lang.Null<bool> onEnd){
			unchecked {
				bool __temp_onEnd210 = ( ( ! (onEnd.hasValue) ) ? (global::haxe.lang.Runtime.toBool(true)) : (onEnd.@value) );
		...
		public override   void doLayout(){
			unchecked {
				this._infos.sort(( (( global::alphatab.rendering.glyphs.ScoreNoteChordGlyph_doLayout_131__Fun.__hx_current != default(global::alphatab.rendering.glyphs.ScoreNoteChordGlyph_doLayout_131__Fun) )) ? (global::alphatab.rendering.glyphs.ScoreNoteChordGlyph_doLayout_131__Fun.__hx_current) : (global::alphatab.rendering.glyphs.ScoreNoteChordGlyph_doLayout_131__Fun.__hx_current = ((global::alphatab.rendering.glyphs.ScoreNoteChordGlyph_doLayout_131__Fun) (new global::alphatab.rendering.glyphs.ScoreNoteChordGlyph_doLayout_131__Fun()) )) ));
				int padding = 0;
				int displacedX = 0;
				...
				{
					object __temp_iterator477 = this.beatEffects.iterator();
					while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator477, "hasNext", 407283053, default(global::haxe.root.Array)))){
						global::alphatab.rendering.Glyph e = ((global::alphatab.rendering.Glyph) (global::haxe.lang.Runtime.callField(__temp_iterator477, "next", 1224901875, default(global::haxe.root.Array))) );
				...
				if (this.beat.tremoloSpeed.hasValue) {
					global::alphatab.rendering.utils.BeamDirection direction = this.beamingHelper.getDirection();
					...
					if (this.beat.tremoloSpeed.hasValue) {
						global::alphatab.model.Duration speed = this.beat.tremoloSpeed.@value;
						switch (global::haxe.root.Type.enumIndex(speed)){
							case 5:
							{
								if (( direction == global::alphatab.rendering.utils.BeamDirection.Up )) {
									offset = -15;
		...
		public override   void paint(int cx, int cy, global::alphatab.platform.ICanvas canvas){
			unchecked {
				...
				{
					object __temp_iterator478 = this.beatEffects.iterator();
					while (global::haxe.lang.Runtime.toBool(global::haxe.lang.Runtime.callField(__temp_iterator478, "hasNext", 407283053, default(global::haxe.root.Array)))){
						global::alphatab.rendering.Glyph g = ((global::alphatab.rendering.Glyph) (global::haxe.lang.Runtime.callField(__temp_iterator478, "next", 1224901875, default(global::haxe.root.Array))) );
						g.y = effectY;
						g.x = ( this.width / 2 );
		...
		public override   object __hx_getField(string field, int hash, bool throwErrors, bool isCheck, bool handleProperties){
			unchecked {
				switch (hash){
					...
					case 67315271:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("hasBottomOverflow") ), ((int) (67315271) ))) );
					}
					
					
					case 455632317:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("hasTopOverflow") ), ((int) (455632317) ))) );
					}
...
#pragma warning disable 109, 114, 219, 429, 168, 162
namespace alphatab.rendering.glyphs{
	public  class ScoreNoteChordGlyph_doLayout_131__Fun : global::haxe.lang.Function {
		public    ScoreNoteChordGlyph_doLayout_131__Fun() : base(2, 1){
			unchecked {
			}
		}
		
		
		public static  global::alphatab.rendering.glyphs.ScoreNoteChordGlyph_doLayout_131__Fun __hx_current;
