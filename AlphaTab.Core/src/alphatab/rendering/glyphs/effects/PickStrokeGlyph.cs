...
namespace alphatab.rendering.glyphs.effects{
	public  class PickStrokeGlyph : global::alphatab.rendering.glyphs.SvgGlyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_effects_PickStrokeGlyph(global::alphatab.rendering.glyphs.effects.PickStrokeGlyph __temp_me263, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::alphatab.model.PickStrokeType pickStroke){
			unchecked {
				global::alphatab.rendering.glyphs.SvgGlyph.__hx_ctor_alphatab_rendering_glyphs_SvgGlyph(__temp_me263, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ), __temp_me263.getNoteSvg(pickStroke), ((double) (1) ), ((double) (1) ));
				int __temp_y262 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x261 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
			}
		}
