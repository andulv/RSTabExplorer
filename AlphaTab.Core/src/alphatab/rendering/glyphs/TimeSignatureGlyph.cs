...
namespace alphatab.rendering.glyphs
{
	public  class TimeSignatureGlyph : global::alphatab.rendering.glyphs.GlyphGroup 
	{
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_TimeSignatureGlyph(global::alphatab.rendering.glyphs.TimeSignatureGlyph __temp_me223, int x, int y, int numerator, int denominator)
		{
			unchecked 
			{
				global::alphatab.rendering.glyphs.GlyphGroup.__hx_ctor_alphatab_rendering_glyphs_GlyphGroup(__temp_me223, new global::haxe.lang.Null<int>(x, true), new global::haxe.lang.Null<int>(y, true), new global::haxe.root.Array<object>());
				__temp_me223._numerator = numerator;
				__temp_me223._denominator = denominator;
			}
		}
