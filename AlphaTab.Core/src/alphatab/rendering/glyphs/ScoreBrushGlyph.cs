...
namespace alphatab.rendering.glyphs{
	public  class ScoreBrushGlyph : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_ScoreBrushGlyph(global::alphatab.rendering.glyphs.ScoreBrushGlyph __temp_me209, global::alphatab.model.Beat beat){
			unchecked {
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me209, new global::haxe.lang.Null<int>(0, true), new global::haxe.lang.Null<int>(0, true));
				__temp_me209._beat = beat;
			}
		}
		...
		public override   void paint(int cx, int cy, global::alphatab.platform.ICanvas canvas){
			unchecked {
				...
				int __temp_stmt627 = default(int);
				{
					double x = ( scoreBarRenderer.getNoteY(this._beat.maxNote()) - ( lineSize / 2 ) );
					__temp_stmt627 = ((int) (x) );
				}
				
				startY = ( ( cy + this.y ) + __temp_stmt627 );
