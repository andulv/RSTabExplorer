...
namespace alphatab.rendering.glyphs.effects{
	public  class VibratoGlyph : global::alphatab.rendering.Glyph {
		...
		public static   void __hx_ctor_alphatab_rendering_glyphs_effects_VibratoGlyph(global::alphatab.rendering.glyphs.effects.VibratoGlyph __temp_me277, global::haxe.lang.Null<int> x, global::haxe.lang.Null<int> y, global::haxe.lang.Null<double> scale){
			unchecked {
				global::alphatab.rendering.Glyph.__hx_ctor_alphatab_rendering_Glyph(__temp_me277, ( ( ! (x.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (x) ), ( ( ! (y.hasValue) ) ? (new global::haxe.lang.Null<int>(0, true)) : (y) ));
				double __temp_scale276 = ( ( ! (scale.hasValue) ) ? (((double) (0.9) )) : (scale.@value) );
				int __temp_y275 = ( ( ! (y.hasValue) ) ? (((int) (0) )) : (y.@value) );
				int __temp_x274 = ( ( ! (x.hasValue) ) ? (((int) (0) )) : (x.@value) );
				__temp_me277._scale = __temp_scale276;
			}
		}
