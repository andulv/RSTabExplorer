...
namespace alphatab.rendering.layout{
	public  class PageViewLayout : global::alphatab.rendering.layout.ScoreLayout {
		...
		public static   void __hx_ctor_alphatab_rendering_layout_PageViewLayout(global::alphatab.rendering.layout.PageViewLayout __temp_me26, global::alphatab.rendering.ScoreRenderer renderer){
			unchecked {
				global::alphatab.rendering.layout.ScoreLayout.__hx_ctor_alphatab_rendering_layout_ScoreLayout(__temp_me26, renderer);
				__temp_me26._groups = new global::haxe.root.Array<object>();
			}
		}
			...
			unchecked {
				...
				if (( this.renderer.settings.staves.length > 0 )) {
					while (( currentBarIndex <= endBarIndex )){
						...
						currentBarIndex = ( ((global::alphatab.model.MasterBar) (@group.bars[( @group.bars.length - 1 )]) ).index + 1 );
					}
		...
		public virtual   int doScoreInfoLayout(int y){
			unchecked {
				...
				if (( ( this.renderer.tracks.length == 1 ) &&  ! (((global::alphatab.model.Track) (this.renderer.tracks[0]) ).isPercussion)  )) {
					global::alphatab.model.Tuning tuning = global::alphatab.model.Tuning.findTuning(((global::alphatab.model.Track) (this.renderer.tracks[0]) ).tuning);
					if (( tuning != default(global::alphatab.model.Tuning) )) {
						...
						if ( ! (tuning.isStandard) ) {
							...
							{
								double x9 = global::System.Math.Ceiling(((double) (( ((double) (((global::alphatab.model.Track) (this.renderer.tracks[0]) ).tuning.length) ) / 2 )) ));
								stringsPerColumn = ((int) (x9) );
							}
							
							int __temp_stmt505 = default(int);
							{
								double x10 = global::System.Math.Floor(((double) (( 15 * scale )) ));
								__temp_stmt505 = ((int) (x10) );
							}
							
							y += ( stringsPerColumn * __temp_stmt505 );
						}
				...
				if (( ( this.renderer.tracks.length == 1 ) &&  ! (((global::alphatab.model.Track) (this.renderer.tracks[0]) ).isPercussion)  )) {
					...
					if (( tuning != default(global::alphatab.model.Tuning) )) {
						...
						if ( ! (tuning.isStandard) ) {
							...
							{
								int _g1 = 0;
								int _g = ((global::alphatab.model.Track) (this.renderer.tracks[0]) ).tuning.length;
								while (( _g1 < _g )){
									int i = _g1++;
									str = global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat(global::haxe.lang.Runtime.concat("(", global::haxe.root.Std.@string(( i + 1 ))), ") = "), global::alphatab.model.Tuning.getTextForTuning(((global::alphatab.model.Track) (this.renderer.tracks[0]) ).tuning[i], false));
							...
							int __temp_stmt506 = default(int);
							{
								double x12 = global::System.Math.Floor(((double) (( 15 * scale )) ));
								__temp_stmt506 = ((int) (x12) );
							}
							
							y += ( stringsPerColumn * __temp_stmt506 );
						}
		...
		public virtual   void fitGroup(global::alphatab.rendering.staves.StaveGroup @group){
			unchecked {
				...
				if (( ( freeSpace != 0 ) && ( @group.bars.length > 0 ) )) {
					barSpace = global::haxe.root.Math.round(( ((double) (freeSpace) ) / @group.bars.length ));
				}
				...
				this.width = global::haxe.root.Math.round(global::System.Math.Max(((double) (this.width) ), ((double) (@group.width) )));
			}
		}
		...
		public virtual   int getSheetWidth(){
			unchecked {
				return global::haxe.root.Math.round(( 950 * this.renderer.settings.scale ));
			}
		}
		...
		public override   object __hx_getField(string field, int hash, bool throwErrors, bool isCheck, bool handleProperties){
			unchecked {
				switch (hash){
					...
					case 667795229:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("getSheetWidth") ), ((int) (667795229) ))) );
					}
					
					
					case 443796344:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("getMaxWidth") ), ((int) (443796344) ))) );
					}
					
					
					case 305429260:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("createStaveGroup") ), ((int) (305429260) ))) );
					}
					
					
					case 1726950318:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("fitGroup") ), ((int) (1726950318) ))) );
					}
					
					
					case 1454772953:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("isNullOrEmpty") ), ((int) (1454772953) ))) );
					}
					
					
					case 166341986:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("paintScoreInfo") ), ((int) (166341986) ))) );
					}
					
					
					case 1698949528:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("drawCentered") ), ((int) (1698949528) ))) );
					}
					...
					case 1365104735:
					{
						return ((global::haxe.lang.Function) (new global::haxe.lang.Closure(((object) (this) ), ((string) ("doScoreInfoLayout") ), ((int) (1365104735) ))) );
					}
		...
		public override   object __hx_invokeField(string field, int hash, global::haxe.root.Array dynargs){
			unchecked {
				switch (hash){
					case 1825584277:case 1331941076:case 776879323:
					{
